...
namespace udit
{
    ...
    Cone::Cone()
    {
        ...
        glBindBuffer (GL_ARRAY_BUFFER, vbo_ids_tip[COORDINATES_VBO]);
    ...
    void Cone::render ()
    {
        ...
        glBindVertexArray (vao_id);
        glDrawArrays    (GL_TRIANGLE_FAN, 0, base_coordinates.size());
        glBindVertexArray (vao_id_tip);
        glDrawArrays    (GL_TRIANGLE_FAN, 0, tip_coordinates.size());
    }
